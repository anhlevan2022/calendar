...
function getNgay(ngayhientai) {
    ...
    strHtml += "</div></div><div class='fooder_lich-lvsicsoft'><div class='fooder_lich_left-lvsicsoft'><a href='javascript:void(0)' onclick='backtoday()'>Quay về ngày hôm nay</a></div><div class='fooder_lich_right-lvsicsoft'><a target='_blank' rel='nofollow' href='https://s-anhlevan.blogspot.com/'>ANHLEVAN<br />" + ngayhientai.getDate() + "/" + (ngayhientai.getMonth() + 1) + "/" + ngayhientai.getFullYear() + "</a></div></div></div></div>\x3c!--End khung-lich--\x3e ";
